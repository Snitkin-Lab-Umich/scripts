...
def parse_coord_aggregate(folder, folder_dir):
    ...
    anno_folder = os.path.basename((folder.replace('_l500_contigs_final_ordered.fasta', '')).replace('.fasta',''))
    ...
    for lines in list_of_coords_files.splitlines():
        ...
        if os.path.basename(lines) == "101c:102b:4763306-4765657:2352.coords":
